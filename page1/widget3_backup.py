...
from .tweets_to_image import get_recent_tweet_images_b64_and_urls
...
def main():
    ...
    # tweet_img64 = get_recent_tweet_images_b64(limit=10)
    ...
    items = get_recent_tweet_images_b64_and_urls(limit=2)
    for b64, tweet_url in items:
        #st.write("Rendering:", tweet_url) 
        html_parts.append(f"""
            <div style='margin-bottom: 20px;'>
            <center>
